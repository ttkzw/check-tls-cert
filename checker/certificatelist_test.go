...
func TestNewCertificateListChecker(t *testing.T) {
	...
	certs, err = x509util.ParseCertificateFile("../test/testdata/pki/cert/valid/server-a-rsa.pem")
	assert.Nil(err)
	...
	certs, err = ParseCertificateFiles("../test/testdata/pki/cert/valid/server-a-rsa.pem", "../test/testdata/pki/cert/valid/ca-intermediate-a-rsa.pem")
	assert.Nil(err)
	c = checker.NewCertificateListChecker(certs)
	...
	certs, err = ParseCertificateFiles("../test/testdata/pki/cert/expired/server-a-rsa.pem", "../test/testdata/pki/cert/valid/ca-intermediate-a-rsa.pem")
	assert.Nil(err)
	c = checker.NewCertificateListChecker(certs)
	...
	//         Expiration: 2020-01-01 09:00:00 +0900
	//         Error     : the certificate has expired on 2020-01-01 09:00:00 +0900
	certs, err = ParseCertificateFiles("../test/testdata/pki/cert/valid/server-a-rsa.pem", "../test/testdata/pki/cert/expired/ca-intermediate-a-rsa.pem")
	assert.Nil(err)
	c = checker.NewCertificateListChecker(certs)
	...
	//         Issuer    : CN=ROOT CA G2 RSA
	//         Expiration: 2031-06-23 15:08:25 +0900
	certs, err = ParseCertificateFiles("../test/testdata/pki/cert/valid/server-b-rsa.pem", "../test/testdata/pki/cert/valid/ca-intermediate-a-rsa.pem")
	assert.Nil(err)
	c = checker.NewCertificateListChecker(certs)
